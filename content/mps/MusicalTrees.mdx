...
1. Pre-Evolve [selection + reproduction] (2 - 10 times) **you decide how many
2. Go through X number of generations **X is a parameter to the function
   - Evolve [selection + reproduction] (2 - 10 times) **you decide how many
   - Prune (details below)
...
#### Image a valid Musical Tree BEFORE pruning.
![enter image description here](https://www.cs128live.org/MuscialTreePre.png)

#### Image a valid Musical Tree After pruning anything below a fitness score of 50 (involved a rotation).
![enter image description here](https://www.cs128live.org/MuscialTreePost.png)
