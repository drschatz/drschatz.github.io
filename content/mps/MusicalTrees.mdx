...
Don't worry, you do not need to have a background in music to successfully complete this project. These specifications will provide 
all the background you will need.
...
Afterwards, you can even take that tune and make it into fire mixtape (not included in this MP).
<audio controls>
